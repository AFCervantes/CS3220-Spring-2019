...
public class DateAndTimeMetrics extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("	<h1>Date &amp; Time Metrics</h1>");
		
		// Insert the page-specific content here...
		out.println("<p class=\"lead\">The date and time has been viewed: " + count + " time(s)</p>");
		out.println("<a href=\"CurrentDateAndTime\">Get the Time</a>");
